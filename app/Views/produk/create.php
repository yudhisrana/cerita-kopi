                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/master-data/produk/store" method="post">
                                <?= csrf_field(); ?>
                                <div class="form-group">
                                    <label for="produk">Produk</label>
                                    <input type="text" class="form-control <?= $validation->hasError('produk') ? 'is-invalid' : '' ?>" id="produk" name="produk" placeholder="Nama produk" value="<?= old('produk') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= $validation->hasError('harga') ? 'is-invalid' : '' ?>" id="harga" name="harga" placeholder="Contoh: 10000 atau 10000.50" value="<?= old('harga') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= $validation->hasError('stok') ? 'is-invalid' : '' ?>" id="stok" name="stok" placeholder="Masukan jumlah stok produk" value="<?= old('stok') ?>">
