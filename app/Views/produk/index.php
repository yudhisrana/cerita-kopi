                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="/master-data/produk/create" type="button" class="btn btn-primary">
                                ...
                                <tbody>
                                    <?php foreach ($produk as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= '/master-data/produk/edit/' . $value->id ?>" type="button" class="btn btn-warning">
...
<script>
    ...
    $(function() {
        $('.btn-delete').click(function() {
            ...
            url = baseUrl + 'master-data/produk/delete/' + id;
            method = 'POST';
