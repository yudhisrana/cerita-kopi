                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= '/master-data/satuan/update/' . $satuan->id; ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= $validation && $validation['satuan'] ? 'is-invalid' : '' ?>" id="satuan" name="satuan" placeholder="Nama satuan" value="<?= old('satuan', $satuan->nama_satuan) ?>">
